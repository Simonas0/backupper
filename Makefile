...
${BIN_DIR}/logger.o: ${SRC_DIR}/logger.h ${SRC_DIR}/logger.cpp ${SRC_DIR}/action.h ${SRC_DIR}/debug.h ${SRC_DIR}/time.h
	mkdir -p ${BIN_DIR}
	${CC} -c ${SRC_DIR}/logger.cpp -o ${BIN_DIR}/logger.o

${BIN_DIR}/cli.o: ${SRC_DIR}/cli.h ${SRC_DIR}/cli.cpp ${SRC_DIR}/logger.h ${SRC_DIR}/time.h
	mkdir -p ${BIN_DIR}
	${CC} -c ${SRC_DIR}/cli.cpp -o ${BIN_DIR}/cli.o

${BIN_DIR}/time.o: ${SRC_DIR}/time.h ${SRC_DIR}/time.cpp
	mkdir -p ${BIN_DIR}
